<?php
namespace common\models\meta\method\form;
use Yii;
use yii\base\Model;
use common\models\GeneralModel;
use common\models\meta\method\MetaPublishingBloodRequestMethod;

class MetaPublishingBloodRequestMethodForm extends MetaPublishingBloodRequestMethod
{
    public $name;
    public $status;
    ...
    public function __construct($model = null)
    {
        $this->formModel = \Yii::createObject([
            'class' => MetaPublishingBloodRequestMethod::className()
        ]);
    ...
    public function rules()
    {
        return [
            [['name'], 'required'],
            [['name'], 'match', 'pattern' => '/^[A-Za-z ().]+$/', 'message' => 'Name can only contain alphabets, spaces, parentheses, and periods.'],
            [['status'], 'integer'],
