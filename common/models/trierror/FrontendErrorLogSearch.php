...
/**
 * FrontendErrorLogSearch represents the model behind the search form of `common\models\FrontendErrorLog`.
 */
class FrontendErrorLogSearch extends FrontendErrorLog
{
