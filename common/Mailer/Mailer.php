...
use common\Mailer\Component\Mailer as SymfonyMailer;
...
{
    public $sentMessage; // new variable to store the result of sending message through the $transport so that we can get the MessageId returned by the API
    ...
    {
        return $this->getSymfonyMailer()->sentMessage;
    }
}
